  ...
  const detailedServices = [
    {
      ...
      icon: <Icons.Home className="h-12 w-12 text-amber-500" />,
      features: [
    ...
    },
    {
      ...
      icon: <Icons.Sun className="h-12 w-12 text-amber-500" />,
      features: [
    ...
    },
    {
      ...
      icon: <Icons.LayoutDashboard className="h-12 w-12 text-amber-500" />,
      features: [
    ...
    },
    {
      ...
      icon: <Icons.Video className="h-12 w-12 text-amber-500" />,
      features: [
    ...
    },
    {
      ...
      icon: <Icons.Wrench className="h-12 w-12 text-amber-500" />,
      features: [
    ...
    <div className="bg-slate-50 min-h-screen pb-20">
      ...
      <div className="bg-slate-900 text-white pt-32 pb-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6 tracking-tight">Our Services</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <button 
          ...
          className="flex items-center text-slate-600 hover:text-amber-600 font-medium transition"
        >
      ...
      <div className="max-w-7xl mx-auto px-4 space-y-12">
        {detailedServices.map((service, index) => (
          <div key={index} className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100 flex flex-col md:flex-row">
            <div className="md:w-1/3 bg-slate-50 p-10 flex flex-col justify-center items-center border-b md:border-b-0 md:border-r border-slate-100 text-center">
      ...
      <div className="max-w-5xl mx-auto px-4 mt-20">
        <div className="bg-amber-500 rounded-3xl p-10 md:p-16 text-center shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">Need a Custom Electrical Solution?</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
               <button 
                ...
                className="bg-slate-900 text-white font-bold py-4 px-8 rounded-xl hover:bg-slate-800 transition shadow-lg"
              >
                Request a Quote
              </button>
            </div>
